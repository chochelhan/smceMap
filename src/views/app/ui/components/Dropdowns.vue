    ...
    <b-row>
      ...
      <b-colxx xxs="12">
        <b-card class="mb-4" :title="$t('dropdowns.sizing')">
          <b-dropdown id="ddown3" :text="$t('dropdowns.large-button')" size="lg" variant="outline-info"
                      class="mr-1 mb-1">
            <b-dropdown-item>{{ $t('dropdowns.action') }}</b-dropdown-item>
            <b-dropdown-item>{{ $t('dropdowns.another-action') }}</b-dropdown-item>
          </b-dropdown>
          <b-dropdown id="ddown4" :text="$t('dropdowns.small-button')" size="sm" variant="outline-info"
                      class="mr-1 mb-1">
            <b-dropdown-item>{{ $t('dropdowns.action') }}</b-dropdown-item>
            <b-dropdown-item>{{ $t('dropdowns.another-action') }}</b-dropdown-item>
          </b-dropdown>
          <b-dropdown id="ddown5" :text="$t('dropdowns.small-button')" size="xs" variant="outline-info"
                      class="mr-1 mb-1">
            <b-dropdown-item>{{ $t('dropdowns.action') }}</b-dropdown-item>
            <b-dropdown-item>{{ $t('dropdowns.another-action') }}</b-dropdown-item>
          </b-dropdown>
      ...
      <b-colxx xxs="12">
        <b-card class="mb-4" :title="$t('dropdowns.drop-directions')">
          ...
          <b-dropdown id="ddown8" :text="$t('dropdowns.dropright')" right variant="secondary"
                      class="mr-1 mb-1 dropright">
            <b-dropdown-item>{{ $t('dropdowns.action') }}</b-dropdown-item>
            <b-dropdown-item>{{ $t('dropdowns.another-action') }}</b-dropdown-item>
          </b-dropdown>
