    ...
    <b-row>
      ...
      <b-colxx xxs="12">
        <b-card class="mb-4" :title="$t('modal.size')">
          <b-button v-b-modal.modallg variant="outline-primary" class="mr-2 mb-2">{{ $t('modal.launch-large-modal') }}
          </b-button>
          <b-button v-b-modal.modalsm variant="outline-primary" class="mb-2">{{ $t('modal.launch-small-modal') }}
          </b-button>
