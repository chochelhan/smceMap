<template>
  <div>
    ...
    <b-row>
      <b-colxx xxs="12">
        <b-button class="mb-1" variant="outline-primary" @click="changeDefaultMenuType('menu-default')">{{
          $t('menu.default') }}
        </b-button>
        <b-button class="mb-1" variant="outline-primary" @click="changeDefaultMenuType('menu-sub-hidden')">{{
          $t('menu.subhidden') }}
        </b-button>
        <b-button class="mb-1" variant="outline-primary" @click="changeDefaultMenuType('menu-hidden')">{{
          $t('menu.hidden') }}
        </b-button>
      </b-colxx>
    </b-row>
