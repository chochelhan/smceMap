<template>
  <div>
        ...
        <b-card class="flex-row listing-card-container" no-body>
          <div class="w-40 position-relative">
            <router-link to="blog-detail">
              ...
              <b-badge v-if="blogItem.badge" variant="primary" pill class="position-absolute badge-top-left">
                {{blogItem.badge}}
              </b-badge>
            </router-link>
          </div>
    ...
    <b-row>
      <b-colxx xxs="12">
        <b-pagination-nav class="justify-content-center pagination" :number-of-pages="5" :link-gen="linkGen"
                          v-model="currentPage" :per-page="5" align="center">
